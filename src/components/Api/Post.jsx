  ...
  return (
    <>
      <div className="listProject">
        <div className="featuredProject">Featured Project</div>
        <div className="titleProject">{Project.title}</div>
        <div className="iconGithub">
          <a href={Project.github} title="github icons">
            <svg
        ...
        <div className="contentPrj">
          <button className="buttonProject">
            <img className="imageProject" src={Project.picture} />
          </button>
